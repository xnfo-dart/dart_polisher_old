...
class StyleFix
{
    static const docComments =
        StyleFix._('doc-comments', 'Use triple slash for documentation comments.');

    static const functionTypedefs =
        StyleFix._('function-typedefs', 'Use new syntax for function type typedefs.');
    ...
    static const optionalConst =
        StyleFix._('optional-const', 'Remove "const" keyword inside constant context.');

    static const optionalNew = StyleFix._('optional-new', 'Remove "new" keyword.');
