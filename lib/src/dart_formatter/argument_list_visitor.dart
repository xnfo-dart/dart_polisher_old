...
class ArgumentListVisitor
{
    ...
    factory ArgumentListVisitor.forArguments(SourceVisitor visitor, Token leftParenthesis,
        Token rightParenthesis, List<Expression> arguments)
    {
    ...
    static List<int>? _contiguousFunctions(List<Expression> arguments)
    {
        ...
        //     },
        //         another: argument);
        // TODO (tekert) this "if block" can be deleted if this is not desired.
...
class ArgumentSublist
{
    ...
    ArgumentSublist._(this._allArguments, this._positional, this._named, this._blocks,
        this._leadingBlocks, this._trailingBlocks);
